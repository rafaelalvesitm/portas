...
class MqttClient:
    def __init__(self):
        ...
        logging.debug(F"Broker: {self.broker_address} | Port: {self.port}")
    ...
    def connect(self):
        while not self.connected:
            try:
                ...
                logging.info(f"Connection failed. Retrying... Error: {e}")
                time.sleep(5)
    ...
    def publish(self, topic, message):
        if self.connected:
            ...
            logging.info("Not connected to the broker. Cannot publish message.")
